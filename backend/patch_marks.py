...
def apply_patch():
    queries = [
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_fa1 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_cla1 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_fa2 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_cla2 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_fa3 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_cla3 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_fa4 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_cla4 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_cla5 NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_internal_overall NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_external NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_external_overall NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS demo_total_overall NUMERIC(5,2);",
        "ALTER TABLE people.student ADD COLUMN IF NOT EXISTS reason VARCHAR(255);"
    ]
    ...
    for q in queries:
        try:
            with engine.begin() as conn:
                conn.execute(text(q))
            logging.info(f"Successfully executed: {q}")
        except Exception as e:
            logging.error(f"Error executing {q}: {e}")

    # Recreate the view to expose these fields
    view_def = """
    ...
    try:
        ...
        logging.info("Recreated view people.v_student_profile with marks columns.")
    except Exception as e:
        logging.error(f"Error recreating view: {e}")

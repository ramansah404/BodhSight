/**
 * FilterContext ΓÇö global scope filter state shared across all pages.
    ...
    async function load() {
      try {
        ...
        if (summary.status === "fulfilled") {
          ...
          if (date) {
            // Extract year for display e.g. "2026-09-12" ΓåÆ "2026-27"
        ...
        // Non-critical ΓÇö filter context degrades gracefully
        setActiveTerm("2026-27");
      } finally {

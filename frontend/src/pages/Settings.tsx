...
import { Settings as SettingsIcon, User, Bell, Building, Globe, CheckCircle2 } from "lucide-react";
          ...
          <div className="space-y-3 pt-2">
            <label className="flex items-center justify-between cursor-pointer">
              <div>
                ...
                <span className="text-xs text-gray-500">Receive instant email alerts when Agent 10 detects a significant grade or pass rate drop.</span>
              </div>
              <input 
                type="checkbox" 
                checked={emailAlerts} 
            ...
            <div className="border-t border-gray-100 pt-3">
              <label className="flex items-center justify-between cursor-pointer">
                <div>
                  ...
                  <span className="text-xs text-gray-500">Get text notifications for high-priority academic interventions requiring immediate sign-off.</span>
                </div>
                <input 
                  type="checkbox" 
                  checked={smsAlerts} 

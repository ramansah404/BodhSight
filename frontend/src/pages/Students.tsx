    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {state === "error" && (
        <div className="bg-white rounded-3xl border border-rose-200 shadow-sm flex flex-col items-center justify-center py-16 gap-4 px-6">
          ...
          <div className="text-center">
            <p className="font-bold text-lg text-gray-900">Failed to load student data</p>
      ...
      {state === "empty" && (
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm flex flex-col items-center justify-center py-16 gap-3 text-gray-400 px-6">
          <Info size={36} />
          <p className="font-semibold text-gray-600">No student backlog data found.</p>
        </div>
      )}
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white p-6 rounded-3xl border border-gray-200 shadow-sm">
              ...
              <div className="text-xs text-gray-500 font-medium mt-1">Active in institution</div>
            </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <span className="px-3 py-1 bg-rose-100 text-rose-800 text-xs font-extrabold rounded-full border border-rose-200">
                        CRITICAL RISK
                      </span>
                      <span className="text-xs font-bold text-gray-500">≥3 active backlogs</span>
                    </div>
                    <h3 className="text-base font-bold text-gray-900">Persistent High-Backlog Students</h3>
                  ...
                  <div className="text-3xl font-black text-rose-700 shrink-0">
                    {backlog.students_high_backlogs}
                  </div>
                </div>
                <div className="mt-4 pt-4 border-t border-rose-200">
                  <p className="text-xs font-bold text-rose-700">Recommended Intervention:</p>
                  <p className="text-sm text-rose-800 font-medium mt-1">
              ...
              {(backlog.students_with_backlogs - backlog.students_high_backlogs) > 0 && (
                <div className="bg-amber-50 rounded-2xl p-5 border border-amber-200">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="px-3 py-1 bg-amber-100 text-amber-800 text-xs font-extrabold rounded-full border border-amber-200">
                          MODERATE RISK
                        </span>
                        <span className="text-xs font-bold text-gray-500">1–2 active backlogs</span>
                      </div>
                      <h3 className="text-base font-bold text-gray-900">Students with Backlogs (1–2)</h3>
                      <p className="text-sm text-gray-600 mt-1">
                    ...
                    <div className="text-3xl font-black text-amber-700 shrink-0">
                      {backlog.students_with_backlogs - backlog.students_high_backlogs}
                    </div>
                  </div>
                  <div className="mt-4 pt-4 border-t border-amber-200">
                    <p className="text-xs font-bold text-amber-700">Recommended Intervention:</p>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-bold text-gray-500">0 backlogs</span>
                    </div>
                    <h3 className="text-base font-bold text-gray-900">Students on Track</h3>
                    <p className="text-sm text-gray-600 mt-1">
                  ...
                  <div className="text-3xl font-black text-emerald-700 shrink-0">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500 font-medium px-2">
            <BookOpen size={14} />
            Data sourced from <code className="bg-gray-100 px-1 rounded">people.v_student_profile</code> via Agent 10 analytics engine.
          </div>
        </>
      )}
    </div>

export default function Batches() {
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="bg-gradient-to-r from-teal-950 via-indigo-900 to-surface rounded-3xl p-8 text-white shadow-xl">
        <h1 className="text-3xl font-extrabold tracking-tight text-white">Batch Progression Intelligence</h1>

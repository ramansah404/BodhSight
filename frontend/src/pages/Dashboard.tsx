...
export default function Dashboard() {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto space-y-6" id="dashboard-content">
      ...
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 bg-surface p-6 rounded-3xl border border-border/60 shadow-lg relative z-[100] overflow-visible relative z-[100]">
        <div>
          ...
          {metrics ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-surface border border-border">
                ...
                <div className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">{metrics.courses_analyzed ?? "ΓÇö"}</div>
              ...
              <div className="p-4 rounded-2xl bg-surface border border-border">
                ...
                <div className="text-sm font-bold text-primary capitalize">
                  ...
                  {metrics.data_source === "database" ? "Γ£à Live Database" : metrics.data_source}
